...
export default function CompanyInfoEdit() {
  ...
  useEffect(() => {
    try {
      ...
      if (axios.isAxiosError(error))
        setCompanyInfoLoading(error.response?.data?.message || '요청 실패');
  ...
  const validate = () => {
    ...
    Object.entries(validateError).forEach((item) => {
      ...
      else if (item[0] === 'manager_email' && !validateEmail(data))
        newerror['manager_email'] = true;
  ...
  return (
    <div className="company_main">
      <div className="CompanyInfoEdit_container">
        <GoArrowLeft className="button_back" onClick={() => navigate(-1)} />
        <h1>기업 정보 수정</h1>
        ...
        <div className="div_company-info">
          ...
          <div className="div_box">
            ...
            <InputText
              ...
              name="company_intro"
              text="기업소개"
              placeholder={formData.company_intro}
            />
          </div>
          {validateError['company_intro'] && (
            <span className="error_message">기업소개를 입력해주세요</span>
          )}
          ...
          <div className="div_box disabled">
            ...
            <InputText
              ...
              text="사업자등록번호"
              disabled={true}
              placeholder={formData.business_reg_number}
            />
          </div>
          ...
          <div className="div_box disabled">
            ...
            <InputText
              ...
              text="개업년월일"
              disabled={true}
              placeholder={formData.opening_date}
            />
          </div>
        ...
        <div className="div_manager-info">
          ...
          <div className="div_box">
            ...
            <InputText
              ...
              name="manager_name"
              text="매니저 이름"
              placeholder={formData.manager_name}
            />
          </div>
          {validateError['manager_name'] && (
            <span className="error_message">이름을 입력해주세요</span>
          )}
          ...
          <div className="div_box">
            ...
            <InputText
              ...
              name="manager_phone"
              text="매니저 전화번호"
              placeholder={formData.manager_phone}
            />
          </div>
          {validateError['manager_phone'] && (
            <span className="error_message">전화번호를 입력해주세요</span>
          )}
          ...
          <div className="div_box">
            ...
            <InputText
              ...
              name="manager_email"
              text="매니저 이메일"
              placeholder={formData.manager_email}
            />
          </div>
          {validateError['manager_email'] && (
            <span className="error_message">이메일을 입력해주세요</span>
          )}
        </div>
        ...
        {showModal &&
          (showModal === 'edit' ? (
            <InfoEditModal formData={formData} setShowModal={setShowModal} />
          ) : showModal === 'out' ? (
            <Modal {...outModal} />
          ) : (
            <Modal {...outCheckModal} />
