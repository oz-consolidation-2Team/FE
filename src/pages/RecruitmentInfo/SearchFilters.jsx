...
const districtsByCity = {
  서울: ['강남구', '강동구', '강북구', '중구', '강서구', '관악구', '광진구', '구로구', '금천구', '노원구', '도봉구', '동대문구', '동작구', '마포구', '서대문구', '서초구', '성동구', '성북구', '송파구', '양천구', '영등포구', '용산구', '은평구', '종로구', '중랑구'],
  부산: ['부산진구', '해운대구', '동래구', '남구', '북구', '사하구', '금정구', '연제구', '수영구', '강서구'],
  인천: ['남동구', '부평구', '계양구', '서구', '연수구', '중구', '미추홀구', '강화군'],
