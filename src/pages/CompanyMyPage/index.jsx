      ...
      <div className="CompanyMyPage_cantainer">
        ...
        <div className="div_info">
          ...
          <button
            ...
            onClick={() => navigate('/mypage/company/announcement/add')}
          >
            공고 작성하기
          </button>
        </div>
        ...
        <h2>나의 공고</h2>
        {jobPostingLoading ? (
          <div className="div_noting">로딩 중...</div>
        ) : jobPosting?.job_postings.length ? (
          jobPosting?.job_postings?.map((item) => <AnnouncementCard {...item} key={item.id} />)
        ) : (
