...
export default function WorkRequirement (props) {
    return (
        <div className="WorkRequirement_container">
            ...
            <div className="div_box move_pos">
                <Category text='급여' />
            ...
            <div className="div_box">
                <Category text='근무시간' />
                <InputDropDown {...props} name='work_start_time' text='근무시작시간' type='time' />
                <p className="p_swung_dash">~</p>
                <InputDropDown {...props} name='work_end_time' text='근무종료시간' type='time' />
